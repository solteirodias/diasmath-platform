...
const labs = [
  {
    ...
    status: "Publicado",
    description:
      "Laboratório de Geometria para investigar ladrilhamentos com polígonos regulares, códigos de vértice e soma angular.",
  ...
  },
  {
    ...
    status: "Publicado",
    description:
      "Laboratório para explorar ciclo trigonométrico, ângulos notáveis, redução ao 1º quadrante, seno, cosseno e tangente.",
  ...
  },
  {
    ...
    status: "Planejado",
    description:
      "Laboratório digital para exploração de pontos, retas, ângulos e polígonos.",
    href: "#",
    emoji: "📏",
    area: "Geometria",
  },
  {
    ...
    status: "Planejado",
    description:
      "Laboratório para manipulação de expressões, equivalências e equações.",
    href: "#",
    emoji: "⚖️",
    area: "Álgebra",
  },
  {
    ...
    status: "Planejado",
    description:
      "Laboratório para relacionar tabela, expressão algébrica e gráfico.",
    href: "#",
    emoji: "📈",
    area: "Funções",
  },
