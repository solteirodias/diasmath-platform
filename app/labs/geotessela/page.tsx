  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="flex h-14 items-center justify-between border-b border-white/10 bg-slate-950 px-4">
        ...
        <p className="text-center text-sm font-bold">Laboratório de Geometria · GeoTessela Lab</p>
        <a href="/labs/geotessela/index.html" target="_blank" className="rounded-full bg-white px-4 py-2 text-sm font-bold text-slate-950">
          Tela cheia
        </a>
      </div>
      <iframe
