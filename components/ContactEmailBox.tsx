    ...
    <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-5 grid gap-4">
            ...
            <label className="block">
              ...
              <textarea
                ...
                rows={5}
                className="mt-1 w-full resize-none rounded-2xl border border-slate-300 bg-white px-4 py-3 outline-none transition focus:border-blue-600 focus:ring-4 focus:ring-blue-100"
              />
            </label>
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="rounded-full bg-blue-600 px-6 py-3 text-sm font-black text-white transition hover:bg-blue-700 disabled:bg-slate-300"
              >
              ...
              <a
                ...
                className={`rounded-full px-6 py-3 text-sm font-black transition ${cleanMessage ? "bg-green-600 text-white hover:bg-green-700" : "pointer-events-none bg-slate-200 text-slate-500"}`}
              >
              ...
              <button
                ...
                className="rounded-full border border-slate-300 px-6 py-3 text-sm font-black text-slate-700 transition hover:border-blue-600 hover:text-blue-700"
              >
                Cancelar
              </button>
            </div>
      ...
      {status === "sent" && (
        <div className="mt-8 rounded-3xl border border-green-200 bg-green-50 p-5">
          ...
          <button type="button" onClick={() => setStatus("idle")} className="mt-4 rounded-full bg-green-600 px-5 py-3 text-sm font-black text-white">
            Fechar
          </button>
        </div>
      )}
